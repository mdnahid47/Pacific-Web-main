...
import api from "../../api";
import SignUp from "./SignUp"; // 👈 new SignUp component import
...
const SigninModals = () => {
  ...
  // Reset error + view on open
  useEffect(() => {
    const modal = document.getElementById("nav_modal");
    const handleModalOpen = () => {
      setError("");
      setShowSignUp(false); // 👈 modal খুললে সবসময় SignIn view
    };
  ...
  const closeModal = () => {
    ...
    if (modal) {
      ...
      setTimeout(() => setShowSignUp(false), 300); // animation শেষে reset
    }
  };
  ...
  return (
    <dialog id="nav_modal" className="modal">
      <div className="modal-box relative max-w-md p-6 sm:p-8 overflow-hidden">
        {/* Close Button */}
        <button
          onClick={closeModal}
          className="btn btn-sm btn-circle btn-ghost absolute right-3 top-3 text-gray-500 z-20"
          disabled={isLoading}
        >
          ✕
        </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  className="input input-bordered w-full rounded-xl focus:border-olympic focus:ring-2 focus:ring-blue-100 transition-all duration-200"
                  required
                  disabled={isLoading}
                />
              </div>
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  <input
                    ...
                    className="input input-bordered w-full pr-10 rounded-xl focus:border-olympic focus:ring-2 focus:ring-blue-100 transition-all duration-200"
                    required
                    disabled={isLoading}
                  />
                  <button
                ...
                <button
                  ...
                  className="label-text-alt link link-hover mt-2 block text-left text-olympic"
                  disabled={isLoading}
                >
                  Forgot password?
                </button>
              ...
              <button
                type="submit"
                className={`btn w-full mt-2 rounded-xl font-bold text-base shadow-lg transition-all duration-300 ${
                  isLoading
