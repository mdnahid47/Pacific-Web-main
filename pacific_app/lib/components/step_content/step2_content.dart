...
class _Step2ContentState extends State<Step2Content> {
  ...
  Future<void> _initializeData() async {
    try {
      ...
      debugPrint('🔄 Step2Content: Loading location data...');
      ...
      if (LocationService.isLoaded) {
        final divisions = LocationService.getDivisionNames();
        debugPrint('✅ Step2Content: Data loaded successfully');
        debugPrint('   Divisions: $divisions');
        debugPrint('   Division count: ${divisions.length}');
        
        if (divisions.isNotEmpty) {
          final firstDiv = divisions.first;
          final districts = LocationService.getDistrictNames(firstDiv);
          debugPrint('   Districts for "$firstDiv": $districts');
          debugPrint('   District count: ${districts.length}');
          
          if (districts.isNotEmpty) {
            final firstDist = districts.first;
            final stations = LocationService.getStationNames(firstDiv, firstDist);
            debugPrint('   Stations for "$firstDist": ${stations.take(3).toList()}...');
            debugPrint('   Station count: ${stations.length}');
          }
        }
      } else {
        debugPrint('❌ Step2Content: Data failed to load!');
        setState(() {
      ...
      debugPrint('❌ Step2Content: Error - $e');
      setState(() {
        _isLoading = false;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildPresentAddressSection(),
          
          const SizedBox(height: 24),

          // Permanent Address Section
          _buildPermanentAddressSection(),
  ...
  Widget _buildPresentAddressSection() {
    return FormCard(
      icon: Icons.home,
      ...
      children: [
        ...
        SearchableDropdown(
          ...
          hintText: 'Search division...',
          onChanged: (value) {
            debugPrint('📌 Present Division selected: $value');
        ...
        SearchableDropdown(
          ...
          onChanged: widget.presentDivision != null
              ? (value) {
                  debugPrint('📍 Present District selected: $value');
        ...
        SearchableDropdown(
          ...
          items: widget.presentDivision != null && widget.presentDistrict != null
              ? LocationService.getStationNames(
                  widget.presentDivision!,
                  widget.presentDistrict!,
                )
              : [],
          hintText: widget.presentDivision != null && widget.presentDistrict != null
              ? 'Search thana...'
              : 'Select district first',
          onChanged: widget.presentDivision != null && widget.presentDistrict != null
              ? (value) {
                  debugPrint('🏢 Present Thana selected: $value');
                  widget.onPresentThanaChanged(value);
                }
              : null,
          enabled: widget.presentDivision != null && widget.presentDistrict != null,
          showClearButton: true,
          isMultiSelect: false,
          contentPadding: const EdgeInsets.symmetric(
            horizontal: 16,
      ...
      children: [
        ...
        if (!widget.sameAsPresentAddress) ...[
          ...
          SearchableDropdown(
            ...
            hintText: 'Search division...',
            onChanged: (value) {
              debugPrint('📌 Permanent Division selected: $value');
          ...
          SearchableDropdown(
            ...
            hintText: widget.permanentDivision != null
                ? 'Search district...'
                : 'Select division first',
            onChanged: !widget.sameAsPresentAddress && widget.permanentDivision != null
                ? (value) {
                    debugPrint('📍 Permanent District selected: $value');
                    widget.onPermanentDistrictChanged(value);
                    widget.onPermanentThanaChanged(null);
                  }
                : null,
            enabled: !widget.sameAsPresentAddress && widget.permanentDivision != null,
            showClearButton: true,
            isMultiSelect: false,
            contentPadding: const EdgeInsets.symmetric(
              horizontal: 16,
          ...
          SearchableDropdown(
            ...
            items: widget.permanentDivision != null && widget.permanentDistrict != null
                ? LocationService.getStationNames(
                    widget.permanentDivision!,
                    widget.permanentDistrict!,
                  )
                : [],
            hintText: widget.permanentDivision != null && widget.permanentDistrict != null
                ? 'Search thana...'
                : 'Select district first',
            onChanged: !widget.sameAsPresentAddress && 
                widget.permanentDivision != null && 
                widget.permanentDistrict != null
                ? (value) {
                    debugPrint('🏢 Permanent Thana selected: $value');
                    widget.onPermanentThanaChanged(value);
                  }
                : null,
            enabled: !widget.sameAsPresentAddress && 
                widget.permanentDivision != null && 
    ...
    return FormCard(
      ...
      children: [
        ...
        SearchableDropdown(
          ...
          hintText: 'Search division...',
          onChanged: (value) {
            debugPrint('📌 Business Division selected: $value');
        ...
        SearchableDropdown(
          ...
          onChanged: widget.businessDivision != null
              ? (value) {
                  debugPrint('📍 Business District selected: $value');
        ...
        SearchableDropdown(
          ...
          items: widget.businessDivision != null && widget.businessDistrict != null
              ? LocationService.getStationNames(
                  widget.businessDivision!,
                  widget.businessDistrict!,
                )
              : [],
          hintText: widget.businessDivision != null && widget.businessDistrict != null
              ? 'Search thana...'
              : 'Select district first',
          onChanged: widget.businessDivision != null && widget.businessDistrict != null
              ? (value) {
                  debugPrint('🏢 Business Thana selected: $value');
                  widget.onBusinessThanaChanged(value);
                }
              : null,
          enabled: widget.businessDivision != null && widget.businessDistrict != null,
          showClearButton: true,
          isMultiSelect: false,
          contentPadding: const EdgeInsets.symmetric(
            horizontal: 16,
